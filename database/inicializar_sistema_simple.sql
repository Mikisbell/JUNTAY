-- INICIALIZAR SISTEMA DE CAJA GENERAL - VERSION SIMPLE
...
BEGIN
    ...
    IF v_count_cajas > 0 THEN
        SELECT id, saldo_total, saldo_disponible, saldo_asignado 
        INTO v_caja_general_id, v_saldo_total, v_saldo_disponible, v_saldo_asignado
        FROM caja_general 
